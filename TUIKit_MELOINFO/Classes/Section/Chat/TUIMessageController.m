...
- (void)sendMessage:(TUIMessageCellData *)msg
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(messageController:willSendMessage:completionHandler:)]) {
        [self.delegate messageController:self willSendMessage:msg completionHandler:completionHandler];
    } else {
